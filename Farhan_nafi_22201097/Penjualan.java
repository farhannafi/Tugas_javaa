...
public class Penjualan {
    public static void main(String[] args) {
        ...
        String[] merek = {"Diablo", "ultima GTR", "Suzuki", "Daihatsu", "Mitsubishi", "Nissan", "Testarosa", "Mazda", "Wuling", "KIA", "Avanza", "Civic", "Carera GT", "Terios", "Xpander", "Livina", "Elf", "CX-5", "Cortez", "Rio"};
        String[] warna = {"Putih","Hitam","Silver","Abu-abu","Merah","Biru","Hijau","Cokelat","Oranye","Kuning"};
        int[] kecepatan = {150, 200, 250, 300, 350, 400};
        String[] model = {"Avanza" ,"Civic" ,"Ertiga" ,"Terios" ,"Xpander" ,"Livina" ,"Elf" ,"CX-5" ,"Cortez" ,"Rio"};
